 ...
 */
public class ConfirmationCreationOpportuniteExceptionGwt extends GwtRunTimeExceptionGwt {
     ...
     */
    public ConfirmationCreationOpportuniteExceptionGwt(String message) {
        super(message);
    }
     ...
     */
    public ConfirmationCreationOpportuniteExceptionGwt() {
        super();
    }
}
