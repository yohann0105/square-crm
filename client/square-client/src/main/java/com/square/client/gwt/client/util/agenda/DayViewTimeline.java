...
/**
 * The Timeline Class is a sequential display of the hours in a day. Each hour label should visually line up to a cell in the DayGrid.
 * @author Brad
 */
public class DayViewTimeline extends Composite {
    ...
    // "4 DEFAULT_AM_LABEL", "5 DEFAULT_AM_LABEL", "6 DEFAULT_AM_LABEL", "7 DEFAULT_AM_LABEL", "8 DEFAULT_AM_LABEL", "9 DEFAULT_AM_LABEL",
    // "10 DEFAULT_AM_LABEL",
    ...
    public void prepare() {
        ...
        while (i < CalendarFormat.HOURS_IN_DAY) {
            ...
            boolean isWorkingHours = ((i-1) >= settings.getSettings().getWorkingHourStart() && (i-1) < settings.getSettings().getWorkingHourEnd());
            if (isWorkingHours) {
