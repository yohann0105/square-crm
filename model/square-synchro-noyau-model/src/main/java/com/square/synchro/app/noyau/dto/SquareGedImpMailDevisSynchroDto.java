 ...
 */
public class SquareGedImpMailDevisSynchroDto extends DefaultMessageSynchroAppDto {

    /** Identificateur de sérialisation. */
    private static final long serialVersionUID = -4041679052404168358L;
    ...
    /** Flag pour s'avoir s'il s'agit une impression (true) ou d'un envoi par mail (false). */
    private boolean impression = true;
