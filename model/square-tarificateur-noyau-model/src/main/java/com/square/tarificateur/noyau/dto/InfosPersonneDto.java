...
import com.square.tarificateur.noyau.dto.personne.InfoSanteDto;

/**
 * DTO modélisant les informations supplémentaires d'une personne nécessaires à une adhésion.
 * @author Nicolas Prouteau (nicolas.prouteau@scub.net) - SCUB
 */
public class InfosPersonneDto implements Serializable {

    /** Identificateur de sérialisation. */
    private static final long serialVersionUID = 810619279656993779L;
    ...
    /** Relation avec un assuré social. */
    private IdentifiantLibelleDto typeRelationAssureSocial;

    /** Lien familial (null si personne principale). */
    private IdentifiantLibelleDto lienFamilial;
     ...
     */
    public IdentifiantLibelleDto getLienFamilial() {
        return lienFamilial;
    }
     ...
     */
    public void setLienFamilial(IdentifiantLibelleDto lienFamilial) {
	 ...
	 */
	public IdentifiantLibelleDto getTypeRelationAssureSocial() {
	 ...
	 */
	public void setTypeRelationAssureSocial(IdentifiantLibelleDto typeRelationAssureSocial) {
