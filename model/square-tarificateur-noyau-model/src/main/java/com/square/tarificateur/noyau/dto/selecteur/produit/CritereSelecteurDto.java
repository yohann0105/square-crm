...
/**
 * Dto representant un critere de produit pour le selecteur de produit.
 * @author Anthony GUILLEMETTE (anthony.guillemette@scub.net) - SCUB
 */
public final class CritereSelecteurDto implements Serializable {

    /** Identificateur de sérialisation. */
    private static final long serialVersionUID = -7845633105403558286L;
    ...
    private List<ValeurCritereSelecteurDto> listeValeursCriteres;
     ...
     */
    public List<ValeurCritereSelecteurDto> getListeValeursCriteres() {
     ...
     */
    public void setListeValeursCriteres(List<ValeurCritereSelecteurDto> listeValeursCriteres) {
    ...
    public Boolean getModifiablePourAdherentPrincipal() {
        // on retourne la valeur de modifiable si modifiablePourAdherentPrincipal n'est pas défini
        if (modifiablePourAdherentPrincipal == null) { return modifiable; }
