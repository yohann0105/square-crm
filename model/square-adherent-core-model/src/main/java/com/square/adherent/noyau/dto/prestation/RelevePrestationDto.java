...
/**
 * DTO représentant un relevé de prestation.
 * @author Nicolas PELTIER (nicolas.peltier@scub.net) - SCUB
 */
public class RelevePrestationDto implements Serializable {

    /** Identifiant de sérialisation. */
    private static final long serialVersionUID = 7221917499619762901L;
    ...
    /**
     * Retourne la valeur de dateImpression.
