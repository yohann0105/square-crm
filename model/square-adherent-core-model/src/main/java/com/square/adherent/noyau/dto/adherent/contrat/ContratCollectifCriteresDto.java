...
/**
 * DTO des critères de recherche de contrats.
 * @author Nicolas PELTIER (nicolas.peltier@scub.net) - SCUB
 */
public class ContratCollectifCriteresDto implements Serializable {

    /** Identificateur de sérialisation. */
    private static final long serialVersionUID = 4767664104048933694L;
