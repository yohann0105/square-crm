...
/**
 * Dto qui représente le retour de cotisation.
 * @author Anthony GUILLEMETTE (anthony.guillemette@scub.net) - SCUB
 */
public class RetourCotisationDto implements Serializable {

    private static final long serialVersionUID = -6999015300187638833L;

    /** Cotisations. */
    private RemotePagingResultsDto<CotisationDto> resultatsCotisation;
     ...
     */
    public RemotePagingResultsDto<CotisationDto> getResultatsCotisation() {
     ...
     */
    public void setResultatsCotisation(RemotePagingResultsDto<CotisationDto> resultatsCotisation) {
