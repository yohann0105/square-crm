...
/**
 * Dto contenant les résultats après une modification d'action.
 * @author cblanchard - SCUB
 */
public class ActionResultatDto implements Serializable {

    /**
     * Serial Version UID.
     */
    private static final long serialVersionUID = -7116241307109902065L;

    /** Identifiant de l'opportunité générée. */
