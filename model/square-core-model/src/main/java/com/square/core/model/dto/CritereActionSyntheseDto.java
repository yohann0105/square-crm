...
/**
 * Dto de critères de recherche pour la récupération d'actions synthèse.
 * @author cblanchard - SCUB
 */
public class CritereActionSyntheseDto implements Serializable {

    /**
     * Serial Version UID.
     */
    private static final long serialVersionUID = 4172831055839112636L;
