...
public interface CotisationService {
	...
	/**
	 * Recherche des cotisations par criteres.
	 * @param criteres critéres de recherche
	 * @return resultat de la recherche
	 */
	CotisationRechercheDto rechercherCotisationParCriteres(CotisationCriteresRechercheDto criteres);
