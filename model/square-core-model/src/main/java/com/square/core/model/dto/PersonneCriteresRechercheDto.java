 ...
 */
public class PersonneCriteresRechercheDto implements Serializable {

    /** Serial Version UID. */
    private static final long serialVersionUID = 2917890631632798226L;
    ...
    /** Liste des identifiants de personnes recherchées. */
    private List<Long> idPersonnes;
    ...
    /** Recherche par nature de téléphone. */
    private List<Long> listeNaturesTelephones;

    /** Flag supprime. */
    private Boolean supprime = Boolean.FALSE;

    /** Liste des identifiants des réseaux. */
    private List<Long> listeReseaux;
    ...
    /**
     * Déinition de la liste des natures.
    ...
    /**
     * Récupère la valeur de idPersonnesAIgnorer.
     * @return la valeur de idPersonnesAIgnorer
     */
    ...
    /**
     * Définit la valeur de idPersonnesAIgnorer.
     * @param idPersonnesAIgnorer la nouvelle valeur de idPersonnesAIgnorer
     */
     ...
     * @param rechercheStricte la nouvelle valeur de isRechercheStricte
     */
    public void setRechercheStricte(boolean rechercheStricte) {
        this.isRechercheStricte = rechercheStricte;
    }

    /**
     * Récupération de listeNaturesTelephones.
     * @return the listeNaturesTelephones
     */
    public List<Long> getListeNaturesTelephones() {
        return listeNaturesTelephones;
    }

    /**
     * Définition de listeNaturesTelephones.
     * @param listeNaturesTelephones the listeNaturesTelephones to set
     */
    public void setListeNaturesTelephones(List<Long> listeNaturesTelephones) {
        this.listeNaturesTelephones = listeNaturesTelephones;
    }

    /**
     * Accesseur pour l'attribut idPersonnes.
     * @return l'attribut idPersonnes
     */
    public List<Long> getIdPersonnes() {
        return idPersonnes;
    }

    /**
     * Définit la valeur de idPersonnes.
     * @param idPersonnes la nouvelle valeur de idPersonnes
     */
    public void setIdPersonnes(List<Long> idPersonnes) {
    ...
    /**
     * Récupère la valeur de listeReseaux.
     * @return la valeur de listeReseaux
     */
    public List<Long> getListeReseaux() {
        return listeReseaux;
    }

    /**
     * Définit la valeur de listeReseaux.
     * @param listeReseaux la nouvelle valeur de listeReseaux
     */
    public void setListeReseaux(List<Long> listeReseaux) {
