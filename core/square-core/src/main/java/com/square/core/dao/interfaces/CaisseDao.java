...
/**
 * Dao pour les caisses.
 * @author cblanchard - SCUB
 */
public interface CaisseDao {
    /**
     * Recherche une caisse par identifiant.
     * @param identifiant l'identifiant.
     * @return la caisse.
     */
    Caisse rechercheCaisseParId(Long identifiant);
     ...
     */
    List<Caisse> rechercherCaisseParCriteres(DimensionCriteresRechercheCaisseDto criteres);
}
