...
/**
 * Implémentation du dao sur les types de campagnes.
 * @author cblanchard - SCUB
 */
public class CampagneTypeDaoImplementation extends HibernateDaoBaseImplementation implements CampagneTypeDao {

    @Override
    public CampagneType rechercherCampagneTypeParId(Long id) {
        return load(id, CampagneType.class);
    }
