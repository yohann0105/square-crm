...
/**
 * Implémentation du dao pour la nature des actions.
 * @author Sylla Mohamed Lamine (lamine08@gmail.com) - SCUB
 */
public class ActionNatureDaoImplementation extends HibernateDaoBaseImplementation implements ActionNatureDao {
    ...
    @Override
    public ActionNature rechercherNatureActionParId(Long idNatureAction) {
        return load(idNatureAction, ActionNature.class);
    }
