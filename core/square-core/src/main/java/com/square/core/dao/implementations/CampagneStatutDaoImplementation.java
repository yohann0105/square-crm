...
/**
 * Implémentation du dao sur les statuts des campagnes.
 * @author cblanchard - SCUB
 */
public class CampagneStatutDaoImplementation extends HibernateDaoBaseImplementation implements CampagneStatutDao {

    @Override
    public CampagneStatut rechercherCampagneStatutParId(Long id) {
        return load(id, CampagneStatut.class);
    }
