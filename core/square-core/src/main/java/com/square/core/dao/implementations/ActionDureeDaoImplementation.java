...
/**
 * Implémentation de l'interface ActionDureeDao.
 * @author Nicolas NADEAU (nicolas.nadeau@scub.net) - SCUB
 */
public class ActionDureeDaoImplementation extends HibernateDaoBaseImplementation implements ActionDureeDao {
    ...
    @Override
    public ActionDuree rechercherDureeActionParId(Long idDureeAction) {
        return load(idDureeAction, ActionDuree.class);
    }
