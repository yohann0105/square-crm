...
/**
 * Implémentation du dao des priorités des actions.
 * @author Sylla Mohamed Lamine (lamine08@gmail.com) - SCUB
 */
public class ActionPrioriteDaoImplementation extends HibernateDaoBaseImplementation implements ActionPrioriteDao {
    ...
    @Override
    public ActionPriorite rechercherPrioriteActionParId(Long idPriorite) {
        return load(idPriorite, ActionPriorite.class);
    }
