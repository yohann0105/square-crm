...
/**
 * Implémentation du dao de l'etat de la ressource.
 * @author Mohamed OULED AMOR (mohamed.ouledamor@gmail.com) - SCUB
 */
public class RessourceEtatDaoImplementation extends HibernateDaoBaseImplementation implements com.square.core.dao.interfaces.RessourceEtatDao {

    @Override
    public RessourceEtat rechercherEtatRessParId(Long identifiant) {
        return load(identifiant, RessourceEtat.class);
    }
