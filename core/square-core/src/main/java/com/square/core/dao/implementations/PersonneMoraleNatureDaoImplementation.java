 ...
 */
public class PersonneMoraleNatureDaoImplementation extends HibernateDaoBaseImplementation implements PersonneMoraleNatureDao {

    @Override
    public PersonneMoraleNature rechercherNaturePersonneMoraleParId(Long id) {
        return load(id, PersonneMoraleNature.class);
    }

    @SuppressWarnings("unchecked")
    @Override
    public List<PersonneMoraleNature> rechercherNaturePersonneMoraleParCriteres(DimensionCriteresRechercheDto criteres) {
