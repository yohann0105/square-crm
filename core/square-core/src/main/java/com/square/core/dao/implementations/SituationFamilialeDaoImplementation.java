...
/**
 * Implémentation du dao sur les situations familiales.
 * @author cblanchard - SCUB
 */
public class SituationFamilialeDaoImplementation extends HibernateDaoBaseImplementation implements SituationFamilialeDao {

    @Override
    public PersonneSituationFamiliale rechercherSituationFamiliale(Long identifiant) {
        return load(identifiant, PersonneSituationFamiliale.class);
    }

    @SuppressWarnings("unchecked")
    @Override
    public List<PersonneSituationFamiliale> rechercherSituationFamilialeParCriteres(DimensionCriteresRechercheDto criteres) {
