...
/**
 * Implémentation du dao du service de la ressource.
 * @author Mohamed OULED AMOR (mohamed.ouledamor@gmail.com) - SCUB
 */
public class RessourceServiceDaoImplementation extends HibernateDaoBaseImplementation implements com.square.core.dao.interfaces.RessourceServiceDao {

    @Override
    public RessourceService rechercherServiceRessParId(Long identifiant) {
        return load(identifiant, RessourceService.class);
    }
