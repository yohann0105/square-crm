...
/**
 * Implémentation du dao du statut de la personne.
 * @author Sylla Mohamed Lamine (lamine08@gmail.com) - SCUB
 */
public class PersonneStatutDaoImplementation extends HibernateDaoBaseImplementation implements PersonneStatutDao {

    @Override
    public PersonneStatut recherchePersonneStatutParId(Long identifiant) {
        return load(identifiant, PersonneStatut.class);
    }
