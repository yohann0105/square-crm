...
/**
 * Implémentation du dao des types d'action.
 * @author Sylla Mohamed Lamine (lamine08@gmail.com) - SCUB
 */
public class ActionTypeDaoImplementation extends HibernateDaoBaseImplementation implements ActionTypeDao {
    ...
    @Override
    public ActionType rechercherTypeActionParId(Long idType) {
        return load(idType, ActionType.class);
    }
