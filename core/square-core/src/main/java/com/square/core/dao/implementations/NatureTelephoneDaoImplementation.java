...
/**
 * Implémentation de natureTelephoneDao.
 * @author Sylla Mohamed Lamine (lamine08@gmail.com) - SCUB
 */
public class NatureTelephoneDaoImplementation extends HibernateDaoBaseImplementation implements NatureTelephoneDao {

    @Override
    public NatureTelephone rechercherNatureTelephoneParId(Long idNatureTelephone) {
        return load(idNatureTelephone, NatureTelephone.class);
    }
