...
/**
 * Modèle d'une finalité d'une ligne devis.
 * @author Nicolas PELTIER (nicolas.peltier@scub.net) - SCUB
 */
@Entity
@Table(name = "DIM_FINALITE")
public class Finalite extends BaseModel {

    /** Identificateur de sérialisation. */
    private static final long serialVersionUID = 3256440317757634102L;

    /** EID de la finalite (Square). */
    @Column(name = "FINALITE_EID", nullable = false)
    ...
    /** Propriété utilitaire permettant l'ordonnancement. */
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof Finalite))
        {
            return false;
        }
