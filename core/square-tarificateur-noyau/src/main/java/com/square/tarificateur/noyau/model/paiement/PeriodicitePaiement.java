 ...
 */
@Entity
@Table(name = "DIM_PERIODICITE_PAIEMENT")
public class PeriodicitePaiement extends BaseModel {

    /** Identificateur de sérialisation. */
    private static final long serialVersionUID = -2224566342140226191L;
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof PeriodicitePaiement)) { return false; }
