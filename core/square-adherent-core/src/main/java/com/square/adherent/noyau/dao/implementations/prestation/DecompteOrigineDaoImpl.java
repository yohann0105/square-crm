...
/**
 * Implementation du dao DecompteOrigine.
 * @author Anthony GUILLEMETTE (anthony.guillemette@scub.net) - SCUB
 */
public class DecompteOrigineDaoImpl extends HibernateDaoBaseImplementation implements DecompteOrigineDao {

    @Override
    @SuppressWarnings("unchecked")
    public List<DecompteOrigine> rechercherOriginesDecompteParCriteres(DimensionAdherentCriteresRechercheDto criteres) {
