...
/**
 * Interface du dao de DecompteOrigine.
 * @author Anthony GUILLEMETTE (anthony.guillemette@scub.net) - SCUB
 */
public interface DecompteOrigineDao {
     ...
     */
    List<DecompteOrigine> rechercherOriginesDecompteParCriteres(DimensionAdherentCriteresRechercheDto criteres);
}
