 ...
 */
package com.square.adherent.noyau.dao.interfaces.banque;
...
/**
 * Interface d'accès aux données des banques.
 * @author Nicolas NADEAU (nicolas.nadeau@scub.net) - SCUB
 */
public interface BanqueDao {

    /**
     * Récupère les information des banques correspondant aux critères de recherche.
     * @param criteres les critères de recherche.
     * @return les banques correspondant aux critères de recherche.
     */
