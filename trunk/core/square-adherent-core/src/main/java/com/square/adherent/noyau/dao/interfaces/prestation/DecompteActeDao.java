...
/**
 * Interface du dao de DecompteActe.
 * @author Anthony GUILLEMETTE (anthony.guillemette@scub.net) - SCUB
 */
public interface DecompteActeDao {

    /**
     * Recherche des actes de decomptes par le libelle.
     * @param criteres les critères de recherche
     * @return la liste des decomptes
     */
    List<DecompteActe> rechercherActesDecompteParCriteres(DimensionAdherentCriteresRechercheDto criteres);
}
