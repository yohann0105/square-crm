...
/**
 * Mock pour le service des constantes de mapping de square.
...
public class SquareMappingServiceImpl implements SquareMappingService {
    ...
    public List<Long> getListeIdsStatutsLoiMadelin() {
        ...
        final Long idActifLoiMadelin = 5L;
        final Long idLoiMadelin = 11L;
        final Long idMembreLoiMadelin = 14L;
        final Long idRetraiteLoiMadelin = 18L;
        listeIds.add(idActifLoiMadelin);
        listeIds.add(idLoiMadelin);
        listeIds.add(idMembreLoiMadelin);
        listeIds.add(idRetraiteLoiMadelin);
        return listeIds;
    }
