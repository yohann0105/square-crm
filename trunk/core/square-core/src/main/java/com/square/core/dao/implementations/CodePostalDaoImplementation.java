...
/**
 * Implémentation du dao sur les codes postaux.
 * @author cblanchard - SCUB
 */
public class CodePostalDaoImplementation extends HibernateDaoBaseImplementation implements CodePostalDao {

    @Override
    public CodePostal rechercheCodePostalParId(Long identifiant) {
        return load(identifiant, CodePostal.class);
    }
