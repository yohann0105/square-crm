...
/**
 * Implémentation du Dao sur les types de voies.
 * @author cblanchard - SCUB
 */
public class TypeVoieDaoImplementation extends HibernateDaoBaseImplementation implements TypeVoieDao {

    @Override
    public TypeVoie rechercheTypeVoieParId(Long identifiant) {
        return load(identifiant, TypeVoie.class);
    }
