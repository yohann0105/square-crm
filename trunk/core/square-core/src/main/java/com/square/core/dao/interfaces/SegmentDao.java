...
/**
 * Dao pour les segments.
 * @author cblanchard - SCUB
 */
public interface SegmentDao {
    /**
     * Recherche un segment par son identifiant.
     * @param identifiant identifiant du segment.
     * @return le segment de la personne.
     */
    PersonneSegment recherchePersonneSegmentParId(Long identifiant);
     ...
     */
    List<PersonneSegment> rechercherSegmentsParCriteres(DimensionCriteresRechercheDto criteres);
}
