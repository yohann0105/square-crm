...
/**
 * Implémentation dao sur personne réseau.
 * @author Sylla Mohamed Lamine (lamine08@gmail.com) - SCUB
 */
public class PersonneReseauDaoImplementation extends HibernateDaoBaseImplementation implements PersonneReseauDao {

    @Override
    public PersonneReseau rechercheReseauParId(Long identifiant) {
        return load(identifiant, PersonneReseau.class);
    }
