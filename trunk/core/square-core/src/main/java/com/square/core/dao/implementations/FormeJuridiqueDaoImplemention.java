...
/**
 * Implémentation du Dao sur les formes juridiques.
 * @author cblanchard - SCUB
 */
public class FormeJuridiqueDaoImplemention extends HibernateDaoBaseImplementation implements FormeJuridiqueDao {
