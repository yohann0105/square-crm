...
/**
 * Implémentation du dao sur la nature des personnes physiques.
 * @author cblanchard - SCUB
 */
public class PersonnePhysiqueNatureDaoImplementation extends HibernateDaoBaseImplementation implements PersonnePhysiqueNatureDao {

    @Override
    public PersonnePhysiqueNature rechercherPersonnePhysiqueParId(Long id) {
        return load(id, PersonnePhysiqueNature.class);
    }

    @SuppressWarnings("unchecked")
    @Override
    public List<PersonnePhysiqueNature> rechercherPersonnePhysiqueNatureParCriteres(DimensionCriteresRechercheDto criteres) {
