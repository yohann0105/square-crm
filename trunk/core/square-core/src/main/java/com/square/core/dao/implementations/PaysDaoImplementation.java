...
/**
 * Implémentation du Dao du pays.
 * @author cblanchard - SCUB
 */
public class PaysDaoImplementation extends HibernateDaoBaseImplementation implements PaysDao {
    ...
    @Override
    public Pays rechercherPaysParId(Long identifiant) {
        return load(identifiant, Pays.class);
    }
}
