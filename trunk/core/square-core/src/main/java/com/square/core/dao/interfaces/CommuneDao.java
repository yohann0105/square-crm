...
/**
 * Dao sur les communes.
 * @author cblanchard - SCUB
 */
public interface CommuneDao {

    /**
     * Recherche de commune par identifiant.
     * @param identifiant l'indentifiant.
     * @return la commune.
     */
    Commune rechercheCommuneParId(Long identifiant);

    /**
     * Recherche de commune par critères.
     * @param criteres les criteres de recherche
     * @return la liste de communes correspondant correspondant aux criteres
     */
    List<Commune> rechercherCommuneParCriteres(CommuneCriteresRechercherDto criteres);
     ...
     * @param criteres les critères de recherche
     * @return la liste des communes - codesPostaux
     */
