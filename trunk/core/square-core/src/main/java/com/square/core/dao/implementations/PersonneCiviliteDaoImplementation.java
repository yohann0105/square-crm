...
/**
 * Implémentation du Dao sur la civilité.
 * @author Sylla Mohamed Lamine (lamine08@gmail.com) - SCUB
 */
public class PersonneCiviliteDaoImplementation extends HibernateDaoBaseImplementation implements PersonneCiviliteDao {

    @Override
    public PersonneCivilite rechercherCiviliteParId(Long identifiant) {
        return load(identifiant, PersonneCivilite.class);
    }
