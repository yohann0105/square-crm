...
/**
 * Implémentation du dao sur la nature de l'adresse.
 * @author cblanchard - SCUB
 */
public class AdresseNatureDaoImplementation extends HibernateDaoBaseImplementation implements AdresseNatureDao {

    @Override
    public AdresseNature rechercheAdresseNatureParId(Long identifiant) {
        return load(identifiant, AdresseNature.class);
    }
