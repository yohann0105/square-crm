...
/**
 * Model des natures des personnes morales.
 * @author Sylla Mohamed Lamine (lamine08@gmail.com) - SCUB
 */
@Entity
@Table(name = "DIM_PERSONNE_MORALE_NATURE")
@Indexed
...
public class PersonneMoraleNature extends ModelDim {

    /**
     * Serial version UID.
     */
    private static final long serialVersionUID = 4255610788284204011L;
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof PersonneMoraleNature)) {
            return false;
        }
