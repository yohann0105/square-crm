...
/**
 * Interface asynchrone des services GWT pour le service des adhérents.
 * @author Nicolas PELTIER (nicolas.peltier@scub.net) - SCUB
 */
public interface AdherentServiceGwtAsync {

    /**
     * Récupère les informations de l'espace personnel d'un adhérent.
     * @param uidPersonne identifiant unique de l'adhérent.
     * @param asyncCallback informations de l'espace personnel de l'adhérent.
     */
    void getInfosEspaceAdherent(Long uidPersonne, AsyncCallback<InfosOptionsAdherentModel> asyncCallback);
     ...
     * @param asyncCallback callback contenant les options mises à jour.
     */
    void mettreAJourListeOptionsAdherent(Long uidPersonne, List<OptionAdherentModel> listeOptions, AsyncCallback<List<OptionAdherentModel>> asyncCallback);
}
