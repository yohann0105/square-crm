...
/**
 * Interface synchrone des services GWT pour les constantes de mapping.
 * @author Nicolas NADEAU (nicolas.nadeau@scub.net) - SCUB
 */
@RemoteServiceRelativePath(value = "handler/constantesMappingService")
public interface ConstantesMappingServiceGwt extends RemoteService {

    /**
     * Récupère les constantes.
     * @return les constantes.
     * @throws GwtRunTimeExceptionGwt erreur authentifiiée.
     */
