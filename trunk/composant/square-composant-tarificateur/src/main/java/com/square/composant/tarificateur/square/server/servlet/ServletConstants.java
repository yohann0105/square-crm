...
public final class ServletConstants {
    ...
    /** BEAN_DEVIS_PDF_SERVICE. */
    public static final String BEAN_DEVIS_PDF_SERVICE = "devisPdfService";

    /** BEAN_FICHIER_UTIL_SERVICE. */
    public static final String BEAN_FICHIER_UTIL_SERVICE = "fichierUtilService";
    ...
    /** URL de récupération d'un BA. */
    public static final String URL_RECUP_BA = "/servlet/getBa";

    /** URL de récupération d'une lettre d'annulation. */
    public static final String URL_RECUP_LETTRE_ANNULATION = "/servlet/getLettreAnnulation";

    /** URL de récupération d'un BA. */
    public static final String PARAM_NRID = "nrid";
}
