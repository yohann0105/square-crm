 ...
 */
public interface SquareLibSuggestListBoxSingleResource extends SuggestListBoxSingleResource {

    /** Instance. */
    SuggestListBoxSingleResource INSTANCE = (SuggestListBoxSingleResource) GWT.create(SquareLibSuggestListBoxSingleResource.class);
