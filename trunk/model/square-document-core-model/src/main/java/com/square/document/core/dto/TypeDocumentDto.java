...
/**
 * Transport d'un type de documents (avec ses sous types).
 * @author jgoncalves - SCUB - SCUB
 */
public class TypeDocumentDto implements Serializable {
    /** Identificateur de sérialisation. */
    private static final long serialVersionUID = -6374676058700836718L;
    ...
    /** Les sous types. */
    private List<TypeDocumentDto> listeTypesDocuments;
     ...
     */
    public List<TypeDocumentDto> getListeTypesDocuments() {
     ...
     */
    public void setListeTypesDocuments(List<TypeDocumentDto> listeTypesDocuments) {
