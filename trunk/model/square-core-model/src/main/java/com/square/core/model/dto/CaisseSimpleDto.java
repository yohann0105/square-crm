 ...
 */
public class CaisseSimpleDto implements Serializable {

    /**
     * serialVersionUID.
     */
    private static final long serialVersionUID = 4111406302704732180L;
     ...
     */
    public CaisseSimpleDto(Long id) {
        super();
        this.id = id;
    }
     ...
     */
    public CaisseSimpleDto(Long id, String nom, String code) {
        super();
        this.id = id;
        this.nom = nom;
        this.code = code;
