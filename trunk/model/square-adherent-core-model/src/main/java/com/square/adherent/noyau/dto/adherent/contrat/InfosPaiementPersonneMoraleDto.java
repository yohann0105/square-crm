...
/**
 * Dto regroupant les informations de paiement des cotisations d'un contrat d'une personne morale.
 * @author Nicolas NADEAU (nicolas.nadeau@scub.net) - SCUB
 */
public class InfosPaiementPersonneMoraleDto extends InfosPaiementDto implements Serializable {
