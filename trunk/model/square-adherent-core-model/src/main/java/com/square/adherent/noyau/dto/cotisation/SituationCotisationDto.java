...
/**
 * Dto qui représente une situation de cotisation.
 * @author Anthony GUILLEMETTE (anthony.guillemette@scub.net) - SCUB
 */
public class SituationCotisationDto implements Serializable {

    private static final long serialVersionUID = -3882261455483266018L;
     ...
     */
    public SituationCotisationDto(String codeAia, String libelle) {
        super();
