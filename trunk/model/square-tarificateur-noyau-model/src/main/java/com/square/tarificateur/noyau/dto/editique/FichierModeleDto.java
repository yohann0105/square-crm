...
/**
 * Dto englobant le DTO d'un fichier et son modèle.
 * @author Clément Lavaud - SCUB
 */
public class FichierModeleDto implements Serializable {

    /** Identificateur de sérialisation. */
	private static final long serialVersionUID = 8283415411718200180L;
