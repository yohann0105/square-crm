...
/**
 * Dto pour les critères de recherche de modèle de devis.
 * @author Nicolas NADEAU (nicolas.nadeau@scub.net) - SCUB
 */
public class CritereModeleDevisDto implements Serializable {

    /** L'identifiant du devis. */
    private Long idDevis;

    /** Identifiant de sérialisation. */
    private static final long serialVersionUID = -8429431750765858608L;
