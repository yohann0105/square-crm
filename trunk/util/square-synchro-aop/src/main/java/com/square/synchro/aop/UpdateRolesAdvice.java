...
/**
 * AOP pour les changements de rôle des utilisateurs.
 * @author nnadeau - SCUB
 */
public class UpdateRolesAdvice implements AfterReturningAdvice {

    /** Logger. */
    private Logger logger = Logger.getLogger(UpdateRolesAdvice.class);
    ...
    public void afterReturning(Object returnValue, Method method, Object[] params, Object target) throws Throwable {
        try {
            if (params[0] instanceof Long) {
                ...
                logger.debug(messageSourceUtil.get(MessageKeyUtil.LOGGER_DEBUG_MODIFICATION_ROLE_RESSOURCE,
