...
/**
 * Model contenant les coordonnées d'une personne.
 * @author Anthony Guillemette (anthony.guillemette@scub.net) - SCUB
 */
public class CoordonneesModel implements IsSerializable {

    /** Identifiant de la personne. */
    private Long idPersonne;

    /** Adresses de la personne. */
    private List<AdresseModel> adresses = new ArrayList<AdresseModel>();

    /** Téléphones de la personne. */
    private List<TelephoneModel> telephones = new ArrayList<TelephoneModel>();

    /** Emails de la personne. */
    private List<EmailModel> emails = new ArrayList<EmailModel>();
     ...
     */
    public void setAdresses(List<AdresseModel> adresses) {
    ...
    public List<TelephoneModel> getTelephones() {
        if (telephones == null) {
            telephones = new ArrayList<TelephoneModel>();
        }
        return telephones;
    }
