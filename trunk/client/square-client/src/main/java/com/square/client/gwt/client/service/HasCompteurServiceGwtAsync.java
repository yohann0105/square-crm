 ...
 */
public interface HasCompteurServiceGwtAsync {
    /**
     ...
     */
    void getCompteursParId(Long id, CompteursModel parametres, AsyncCallback<CompteursModel> callback) throws GwtRunTimeExceptionGwt;
}
