 ...
 */
public interface CotisationServiceGwtAsync {

    /**
     * Recherche des cotisations par critère.
     * @param criteres les critères
     * @param asyncCallback le callback
     */
    void rechercherCotisationParCriteres(RemotePagingCriteriasGwt<CotisationCriteresRechercheModel> criteres,
        AsyncCallback<RemotePagingResultsGwt<CotisationRechercheModel>> asyncCallback);
