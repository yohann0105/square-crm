...
/**
 * Interface pour les constantes de la popup de d'ajout d'enfant au conjoint.
 * @author Raphaël Marnier - SCUB
 */
public interface PersonneRelationAjouterEnfantConjointViewImplConstants extends Constants {
