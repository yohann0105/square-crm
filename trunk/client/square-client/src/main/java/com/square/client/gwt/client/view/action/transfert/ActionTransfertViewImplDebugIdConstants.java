...
/**
 * Interface des constantes de debug de la vue ActionTransfertView.
 * @author Anthony GUILLEMETTE (anthony.guillemette@scub.net) - SCUB
 */
public interface ActionTransfertViewImplDebugIdConstants extends Constants {
