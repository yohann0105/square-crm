...
/**
 * Interface synchrone des services GWT utilitaires.
 * @author Anthony GUILLEMETTE (anthony.guillemette@scub.net) - SCUB
 */
@RemoteServiceRelativePath(value = "handler/utilService")
public interface UtilServiceGwt extends RemoteService {

    /**
     * Transforme des criteres de recherche en map libelle/valeur.
     * @param criteres criteres à convertir
     * @return la map
     * @throws GwtRunTimeExceptionGwt exception
     */
    Map<String, String> mapperCriteresRecherche(RemotePagingCriteriasGwt<? extends IsSerializable> criteres) throws GwtRunTimeExceptionGwt;
     ...
     * @throws GwtRunTimeExceptionGwt exception
     */
    List<IdentifiantLibelleOuiNonModel> getListeOuiNon() throws GwtRunTimeExceptionGwt;
