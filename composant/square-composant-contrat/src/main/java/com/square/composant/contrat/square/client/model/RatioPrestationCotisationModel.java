...
/**
 * Model représentant le ration prestation/cotisation pour une année et pour une personne.
 * @author Nicolas PELTIER (nicolas.peltier@scub.net) - SCUB
 */
public class RatioPrestationCotisationModel implements IsSerializable {

    /** Année. */
    private int annee;

    /** Personne. */
    private IdentifiantLibelleGwt personne;
     ...
     */
    public IdentifiantLibelleGwt getPersonne() {
        return personne;
    }
     ...
     */
    public void setPersonne(IdentifiantLibelleGwt personne) {
