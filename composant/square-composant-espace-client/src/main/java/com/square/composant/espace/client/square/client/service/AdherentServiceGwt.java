...
/**
 * Interface synchrone des services GWT pour le service des adhérents.
 * @author Nicolas PELTIER (nicolas.peltier@scub.net) - SCUB
 */
@RemoteServiceRelativePath(value = "handler/adherentEspaceAdherentService")
public interface AdherentServiceGwt extends RemoteService {
     ...
     */
    InfosOptionsAdherentModel getInfosEspaceAdherent(Long uidPersonne) throws GwtRunTimeExceptionGwt;
     ...
     * @throws GwtRunTimeExceptionGwt Exception levée à l'exécution par GWT.
     */
    List<OptionAdherentModel> mettreAJourListeOptionsAdherent(Long uidPersonne, List<OptionAdherentModel> listeOptions) throws GwtRunTimeExceptionGwt;
}
