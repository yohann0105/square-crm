...
/**
 * Point d'entrée pour le module prestations.
 * @author Anthony GUILLEMETTE (anthony.guillemette@scub.net) - SCUB
 */
public class ComposantPrestationsModule implements EntryPoint {
    ...
    public void onModuleLoad() {
        ...
        final ComposantPrestations composantPrestations = new ComposantPrestations(eventBus, new ComposantPrestationsViewImpl(), uidPersonne);
