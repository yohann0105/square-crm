 ...
 */
public class ProprieteFusionnableStringModel extends ProprieteFusionnableModel {
    ...
    /** Constructeur. */
    public ProprieteFusionnableStringModel() {
        super();
    }
     ...
     */
    public ProprieteFusionnableStringModel(String valeur, Boolean different) {
        super(different);
        this.valeur = valeur;
    }
