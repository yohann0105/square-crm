 ...
 */
package com.square.composant.fusion.square.client;
 ...
 */
public final class ComposantFusionModule implements EntryPoint {
    ...
    public void onModuleLoad() {
        ...
        final ComposantFusionPresenter composantFusionPresenter = new ComposantFusionPresenter(eventBus, criteres, null);
