 ...
 */
public class BlocInfoSanteSimpleViewImpl extends Composite implements BlocInfoSanteSimple {
     ...
     */
    public BlocInfoSanteSimpleViewImpl(InfosAdhesionViewImplConstants viewConstants, String suffix, IconeErreurChampManager iconeErreurChampManager) {
        super();
