...
/**
 * AOP pour la validation d'un utilisateur.
 * @author nnadeau - SCUB
 */
public class ValiderUtilisateurAdvice implements AfterReturningAdvice {

    /** Logger. */
    private Logger logger = Logger.getLogger(ValiderUtilisateurAdvice.class);
    ...
    public void afterReturning(Object returnValue, Method method, Object[] params, Object target) throws Throwable {
        try {
            if (params[0] instanceof Long) {
                ...
                logger.debug(messageSourceUtil.get(MessageKeyUtil.LOGGER_DEBUG_VALIDATION_RESSOURCE,
            ...
            logger.fatal(messageSourceUtil.get(MessageKeyUtil.LOGGER_FATAL_SYNCHRONISATION_VALIDATION_RESSOURCE,
             		 new String[] {String.valueOf(e.getMessage())}), e);
        }
    }
