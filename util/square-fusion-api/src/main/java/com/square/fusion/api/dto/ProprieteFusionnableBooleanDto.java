 ...
 */
public class ProprieteFusionnableBooleanDto extends ProprieteFusionnableDto {
    ...
    /** Constructeur. */
    public ProprieteFusionnableBooleanDto() {
        super();
    }
     ...
     */
    public ProprieteFusionnableBooleanDto(Boolean valeur, Boolean different) {
        super(different);
        this.valeur = valeur;
    }
