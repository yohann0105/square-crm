...
/**
 * DTO représentant une personne cible à fusionner.
 * @author Nicolas PELTIER (nicolas.peltier@scub.net) - SCUB
 */
public class PersonneCibleFusionDto extends PersonneFusionDto {

    /** Identificateur de sérialisation. */
    private static final long serialVersionUID = 5182588516935735339L;
     ...
     */
    private IdentifiantLibelleDto caisse;
     ...
     */
    private IdentifiantLibelleDto commercial;
    ...
    /** Adresse principal. */
    private AdresseFusionDto adressePrincipale;

    /** Liste des téléphones. */
    private List<TelephoneFusionDto> listeTelephones;

    /** Liste des e-mails. */
    private List<EmailFusionDto> listeEmails;
     ...
     */
    public IdentifiantLibelleDto getCaisse() {
        return caisse;
    }
     ...
     */
    public void setCaisse(IdentifiantLibelleDto caisse) {
        this.caisse = caisse;
    }
     ...
     */
    public IdentifiantLibelleDto getCommercial() {
        return commercial;
    }
     ...
     */
    public void setCommercial(IdentifiantLibelleDto commercial) {
     ...
     */
    public AdresseFusionDto getAdressePrincipale() {
     ...
     */
    public void setAdressePrincipale(AdresseFusionDto adressePrincipale) {
     ...
     */
    public List<TelephoneFusionDto> getListeTelephones() {
     ...
     */
    public void setListeTelephones(List<TelephoneFusionDto> listeTelephones) {
     ...
     */
    public List<EmailFusionDto> getListeEmails() {
        return listeEmails;
    }
     ...
     */
    public void setListeEmails(List<EmailFusionDto> listeEmails) {
